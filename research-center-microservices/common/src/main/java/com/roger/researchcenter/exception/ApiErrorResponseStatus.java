...
public enum ApiErrorResponseStatus {
    ...
    REGISTRATION_TOKEN_EXPIRED("40022", HttpStatus.BAD_REQUEST),
    EQUIPMENT_TYPE_EXISTS("40023", HttpStatus.BAD_REQUEST),
    INCORRECT_REQUEST_DATA("40099", HttpStatus.BAD_REQUEST),

    BAD_CREDENTIALS("40101",HttpStatus.UNAUTHORIZED),
    BAD_AUTH_HEADER("40102",HttpStatus.UNAUTHORIZED),
