...
public enum ApiErrorResponseStatus {
    ...
    INCORRECT_NAME("40001", HttpStatus.BAD_REQUEST),
    INCORRECT_DESCRIPTION("40002", HttpStatus.BAD_REQUEST),
    INCORRECT_PRICE("40003", HttpStatus.BAD_REQUEST),
    INCORRECT_ID("40004", HttpStatus.BAD_REQUEST),
    INCORRECT_RESEARCH_TIME("40005", HttpStatus.BAD_REQUEST),
    INCORRECT_ADDRESS("40006", HttpStatus.BAD_REQUEST),
    INCORRECT_LOCATION("40007", HttpStatus.BAD_REQUEST),
    EQUIPMENT_EXISTS("40008", HttpStatus.BAD_REQUEST),
    LABORATORY_EXISTS("40009", HttpStatus.BAD_REQUEST),
    INCORRECT_REQUEST_DATA("40099", HttpStatus.BAD_REQUEST),

    NOT_FOUND("40400", HttpStatus.NOT_FOUND),
    NOT_FOUND_EQUIPMENT_ID("40401", HttpStatus.NOT_FOUND),
    NOT_FOUND_LABORATORY_ID("40402", HttpStatus.NOT_FOUND),
    NOT_FOUND_EQUIPMENT_TYPE_ID("40403", HttpStatus.NOT_FOUND),
    NOT_FOUND_DEPARTMENT_ID("40404", HttpStatus.NOT_FOUND),

    NOT_UPDATED_ID("40405", HttpStatus.NOT_FOUND),
    NOT_FOUND_EQUIPMENT("40406", HttpStatus.NOT_FOUND),
